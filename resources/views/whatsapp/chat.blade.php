                        ...
                        <nav>
                          ...
                          <div class="tab-content" id="nav-tabContent" x-cloak>
                            ...
                            <template x-for="contactItem in filteredContacts">
                                ...
                                @endif
                                <a x-show="(contact && contact._uid == contactItem._uid) || (showUnreadContactsOnly && contactItem.unread_messages_count) || !showUnreadContactsOnly" @click.prevent="isContactListOpened = false" :data-messaged-at="contactItem.last_message?.messaged_at" @click="whatsappMessageLogs = [];messagePaginatePage = 0;contact.__data = {}"
